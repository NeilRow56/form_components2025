...
export default function AdvancedFullForm() {
  const form = useForm({
    defaultValues: {
      name: '',
      description: '',
  ...
  return (
    <Card className='w-full sm:max-w-md'>
      <CardHeader>
        <CardTitle>Advanced Form Report</CardTitle>
        <CardDescription>
          Help us improve by reporting form errors you encounter.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    ...
                    <Select
                      onValueChange={e =>
                        field.handleChange(
                          e as (typeof PROJECT_STATUSES)[number]
                        )
                      }
                      value={field.state.value}
                    >
